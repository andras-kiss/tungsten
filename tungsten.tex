...
\begin{document}
\begin{abstract}
We demonstrate the fabrication of a simple and economical metal/metal--oxide type hydrogen--ion selective electrode using simple household items. The sensing element is made from the tungsten alloy filament of an incandescent lightbulb, that is sandwiched between two pieces of Plexiglass using superglue. 
...
The aim of this paper is to avail teachers of an additional interesting and engaging experiment to teach students about ion--selective electrodes and pH.
