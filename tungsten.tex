...
\author{Géza Nagy}
\affiliation{Department of General and Physical Chemistry, University of Pécs, Ifjúság útja 6, 7622 Pécs, Hungary}
\title{An inexpensive pH sensitive electrode made from the tungsten filament of an incandescent light--bulb}
...
pH is one of the most important analytical parameters, therefore a lot of work has been devoted even just to define it. The original definition \cite{sorensen1909messung} was layed down by S\o rensen in 1909, as the negative logarithm of the concentration of H$_3$O$^+$:
